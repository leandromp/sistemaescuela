    ...
    $.formUtils = {
        ...
        */
        LANG : {
            ...
            requiredFields : 'No completo los campos requeridos',
            badTime : 'No ingreso una hora correcta',
            badEmail : 'No ingreso una direccion de correo valida',
            badTelephone : 'No ingreso un numero de telefono valido',
            badSecurityAnswer : 'No ingreso una respuesta correcta a la pregunta de seguridad',
            badDate : 'No ingreso un formato de fecha valida',
            lengthBadStart : 'Su respuesta debe ser entre ',
            lengthBadEnd : ' caracteres',
            lengthTooLongStart : 'Su respuesta fue mayor a ',
            lengthTooShortStart : 'Su respuesta fue menor a ',
            notConfirmed : 'Los valores no pueden ser confirmados',
            badDomain : 'Dominio incorrecto',
            badUrl : 'No ingreso una URL valida',
            badCustomVal : 'No es una respuesta correcta',
            badInt : 'No ingreso un numero',
            badSecurityNumber : 'Su numero de seguro social no es valido',
            badUKVatAnswer : 'Incorrect UK VAT Number',
            badStrength : 'La contraseña no es lo suficientemente segura',
            badNumberOfSelectedOptionsStart : 'Debe escoger al menos ',
            badNumberOfSelectedOptionsEnd : ' respuetas',
            badAlphaNumeric : 'La respuesta que brindo debe contener solo letras y numeros ',
